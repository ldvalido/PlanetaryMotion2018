...
(function (Innovasys) {
    ...
    (function (Content) {
        var Features;
        (function (Features) {
            var TopicsDocumentFeatureFactory = (function () {
            ...
            var TopicsDocumentFeature = (function (_super) {
                __extends(TopicsDocumentFeature, _super);
                function TopicsDocumentFeature(documentInstance) {
                    _super.call(this, documentInstance);
                }
                ...
                TopicsDocumentFeature.prototype.applyResponsiveConfiguration = function (configuration) {
                    ...
                    if (configuration.profileName == "mobile") {
                        $(".i-glossary-letter-header").addClass("i-section-heading").next().addClass("i-section-content");
                    }
                };
